			...
			<div className="relative z-10 max-w-5xl mx-auto px-4">
				<div className="text-center space-y-6">
					...
					<div className="space-y-4 sm:space-y-6 mt-6 sm:mt-8">
						<div className="flex flex-col items-center gap-4">
							<div className="flex items-center gap-3">
								...
								<h2 className="text-xl sm:text-2xl font-light tracking-wide text-blue-400">Front End Web Developer</h2>
								<span className="h-[1px] w-8 sm:w-12 bg-blue-500"></span>
							</div>
						...
						<div className="flex flex-wrap justify-center gap-2 sm:gap-3 mt-6 sm:mt-8 px-4 sm:px-0">
							{['React.js', 'Next.js', 'TypeScript', 'Tailwind CSS', 'Shopify', 'WordPress', 'JavaScript'].map((tech) => (
								<span
									key={tech}
					...
					<div className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-4 mt-8 sm:mt-12 px-4 sm:px-0">
						...
						<a
							href="https://wa.me/919876543210?text=Hi%20Avadh%2C%20I%20found%20your%20portfolio%20interesting!"
